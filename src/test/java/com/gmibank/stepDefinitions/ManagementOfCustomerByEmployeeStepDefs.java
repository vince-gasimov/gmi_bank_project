...
public class ManagementOfCustomerByEmployeeStepDefs {
    ...
    public void verify_that_a_table_is_displayed_in_the_Customers_page_with_following_columns(List<String> columnNameList) {
        ...
        BrowserUtils.waitForVisibility(customer.pageHeader, 10);
        System.out.println("customer.getColumnNameList() = " + customer.getColumnNameList());
        Assert.assertTrue(customer.doesGivenColumnListExist(columnNameList));
    }
