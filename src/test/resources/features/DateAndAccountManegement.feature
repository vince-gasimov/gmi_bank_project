...
Feature:Date enter and Account Manage
  ...
  @us1401
  ScenarioUS_14_TC01The date cannot be typed earlier, in the past, at the time of creation an account
    ...
    And User must be take if a invalid format Date"InvalidFormatDate" the alert
